...
class Post
{
    ...
    function create($DATA, $FILES, $image_class = null)
    {
        ...
        $slag_arr['url_address'] = $arr['url_address'];
        ...
        if (!isset($_SESSION['error']) || $_SESSION['error'] == "") {
            ...
            $query = "insert into blogs (title, post, date, user_url, image, url_address) values 
                                       (:title,:post,:date,:user_url,:image,:url_address)";
