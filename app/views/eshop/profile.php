		...
		<div style="min-height: 300px; max-width: 1000px; margin: auto; ">
			...
			<div class="col-md-4 mb"
				...
				<div class="white-panel pn">
					...
					<div class="row">
						<div class="col-md-6">
							<p class="small mt" style="cursor: pointer; color: #00aaff;"><i class="fa fa-edit"></i> EDIT
							</p>
						</div>
						<div class="col-md-6">
							<p class="small mt" style="cursor: pointer; color: #b22222;"><i class="fa fa-trash-o"></i>
								DELETE</p>
						</div>
					</div>
