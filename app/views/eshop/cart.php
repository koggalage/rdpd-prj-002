			...
			<table class="table table-condensed">
				...
				<tbody>
					...
					<?php if ($ROWS): ?>
							...
							<tr>
								...
								<td class="cart_quantity">
									<div class="cart_quantity_button">
										<a class="cart_quantity_up" href="<?= ROOT ?>add_to_cart/add_quantity/<?= $row->id ?>">
											+ </a>
						...
						<?php endforeach; ?>
					<?php else: ?>
						<div style="font-size: 18px; text-align: center; padding: 6px;">No items were found in the cart
						</div>
					<?php endif; ?>
